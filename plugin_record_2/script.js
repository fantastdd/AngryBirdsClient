...
*****************************************************************************/
   //var window_id = 0;
     //   var windows = new Array("Alice","Bob","Gary");
(     
   function() {
    ...
    function connect() {
        ...
        console.log('Connecting Video Capturing 2 test...');
        sock = new WebSocket('ws://localhost:9999/');
        //console.log(' test ' + tab.id);
        sock.onopen = function() {
            console.log('Connected Video Capturing 2');
            //window.status = windows[window_id++];
            //console.log(windows);
            //var string = windows[window_id];
            //window_id++;
            //console.log(string);
        };
        ...
        sock.onmessage = function(e) {
            console.log('Message received: ' + e.data +' window status ' + window.status);
