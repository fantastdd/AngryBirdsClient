...
public class TrackingRect extends TrackingBody
{
   ...
   /* public static void main(String args[])
	...
	{
		return String.format("Rect: id:%d ABType:%s rectType:%s Area:%d w:%7.3f h:%7.3f a:%3.3f at x:%3.1f y:%3.1f isDebris:%b", id, type, rectType, area, preciseWidth, preciseHeight, angle, centerX, centerY, isDebris);
	}
}
