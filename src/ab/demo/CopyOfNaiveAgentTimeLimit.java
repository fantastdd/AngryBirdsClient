...
public class CopyOfNaiveAgentTimeLimit implements Runnable {
	...
	public CopyOfNaiveAgentTimeLimit() {
		ar = new ActionRobot();
	 ...
	 public static String[] extract(String[] commands)
	    {
		   ...
		   else
		   {
			   ...
			   if (_option.equalsIgnoreCase("-t"))
			   {
				   ...
				   CopyOfNaiveAgentTimeLimit.time_limit = time_limit;
				   ...
				   if(_option.equalsIgnoreCase("-l"))
				   {
					   ...
					   CopyOfNaiveAgentTimeLimit.currentLevel = level;
				   }
	...
	public static void main(String args[]) {
		...
		CopyOfNaiveAgentTimeLimit na = new CopyOfNaiveAgentTimeLimit();
		extract(args);
		na.run();
